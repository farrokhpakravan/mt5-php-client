...
use Farrokhpakravan\Mt5PhpClient\Exceptions\TradeException;
use Farrokhpakravan\Mt5PhpClient\Exceptions\UserException;
use Farrokhpakravan\Mt5PhpClient\Lib\MTAuthProtocol;
use Farrokhpakravan\Mt5PhpClient\Lib\MTConnect;
use Farrokhpakravan\Mt5PhpClient\Lib\MTDealProtocol;
use Farrokhpakravan\Mt5PhpClient\Lib\MTEnDealAction;
use Farrokhpakravan\Mt5PhpClient\Lib\MTHistoryProtocol;
use Farrokhpakravan\Mt5PhpClient\Lib\MTLogger;
use Farrokhpakravan\Mt5PhpClient\Lib\MTOrder;
use Farrokhpakravan\Mt5PhpClient\Lib\MTOrderProtocol;
use Farrokhpakravan\Mt5PhpClient\Lib\MTPosition;
use Farrokhpakravan\Mt5PhpClient\Lib\MTPositionProtocol;
use Farrokhpakravan\Mt5PhpClient\Lib\MTRetCode;
use Farrokhpakravan\Mt5PhpClient\Lib\MTTradeProtocol;
use Farrokhpakravan\Mt5PhpClient\Lib\MTUser;
use Farrokhpakravan\Mt5PhpClient\Lib\MTUserProtocol;
use Farrokhpakravan\Mt5PhpClient\Traits\Deal;
...
class Mt5PhpClient
{
     ...
     * @param false       $debug
     */
    public function __construct($server = null, $port = null, $username = null, $password = null, $debug = false)
    {
        $file_path = 'logs/';
        $this->m_agent = "WebAPI";
        $this->m_is_crypt = true;
        MTLogger::Init($this->m_agent, $debug, $file_path);
        $this->server = $server ?? config('mt5-php-client.HOST');
        $this->port = $port ?? config('mt5-php-client.PORT');
        $this->username = $username ?? config('mt5-php-client.USERNAME');
        $this->password = $password ?? config('mt5-php-client.PASSWORD');
        $this->debug = $debug;
    }
    ...
    public function createUser(User $user): User
    {
        ...
        if ($result != MTRetCode::MT_RET_OK) {
            throw new UserException(MTRetCode::GetError($result), $result);
        }
